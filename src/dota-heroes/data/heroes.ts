...
export const heroes: Hero[] = [
    ...
    },
    {
        ...
        'attribute': "Agility",
        'attack': "meele",
        'information': "Anti-Mage, is a fast melee agility name with an emphasis on disrupting and killing high-mana enemies. He has notably high agility and low base attack time, giving him high damage and scaling with his basic attacks. His signature ability is Mana Break, a passive attack modifier that makes him a huge threat to mana-reliant namees, mainly Intelligence-based casters. In addition to granting substantial bonus damage on each attack, its mana burn sets enemies up to be devastated by his ultimate ability, Mana Void. Blink is a highly versatile ability that allows Anti-Mage to instantly teleport short distances, thereby allowing him to escape, chase, and even farm with ease. Combined with his high base movement speed, this makes Anti-Mage a highly mobile name at all points in the game. Counterspell greatly increases Anti-Mage's magic resistance, allowing him to sustain more damage from enemy casters. Finally, Mana Void finishes off targets after their mana has been burned, inflicting heavy damage to both the target and enemies surrounding the target. The damage Mana Void can potentially deal scales extremely well into the late game, as enemies' mana pools only grow larger over time. His naturally fast basic attacks combined with his powerful abilities make him extremely dangerous in the late game, allowing him to devastate enemies with ease if he is allowed to farm as a hard carry.",
    },
    {
        ...
        'attribute': "Agility",
        'attack': "ranged",
        'information': "Zet, the Arc Warden, is a ranged agility name that requires micromanagement and farm to spiral out of control. In the early stages of the game, it is a very powerful nuker. Its first ability, Flux, allows Arc Warden to cripple an enemy down and deal large amounts of damage. It and other allied namees or buildings can be protected from physical attacks with its second ability Magnetic Field, while gaining swift attack speed. Similar to Techies' Proximity Mines, Arc Warden's third ability, Spark Wraith, allows it to place wraiths that attack when an enemy goes near them, potentially dealing large amounts of magical damage. Finally, thanks to its ultimate, Tempest Double, which allows it to make a perfect copy of itself that can use all of Arc Warden's spells and item abilities, it can spam all of its other abilities and most items twice and easily take down fragile namees in the early game, or keep itself or its team doubly sustained through certain buffing or healing items. This makes Arc Warden very powerful in both early and late game if given enough farm, from magical nuker to physical carry, or if the time calls it, a very potent support",
    },
    {
